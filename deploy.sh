...
echo "   - Frontend: Served by Caddy on http://localhost"
echo ""
echo "📋 Next steps:"
echo "   1. Start Caddy: APP_ROOT=$(pwd) caddy run"
echo "   2. Set up your domain DNS (optional)"
echo "   3. Update Caddyfile with your domain for HTTPS"
